...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
private:
	Stack( const Stack &another ) noexcept = delete;
	const Stack &operator =( const Stack &another ) noexcept = delete;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
private:
	Stack( Stack &&another ) noexcept = delete;
	Stack &operator =( Stack &&another ) noexcept = delete;
