...
public:
	...
	typeing::Memory_natural get_size() const;
...
private:
	Amp_data(
		...
		typeing::Memory_natural a_size ) noexcept;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
	template< class A_created_type >
	static Amp_data create(
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
	Amp_data( const Amp_data &another ) noexcept;
	const Amp_data &operator =( const Amp_data &another ) noexcept;

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
public:
	Amp_data( Amp_data &&another ) noexcept;
	Amp_data &operator =( Amp_data &&another ) noexcept;

// # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
private:
	Omp_data< A_type > _the_omp_data;
