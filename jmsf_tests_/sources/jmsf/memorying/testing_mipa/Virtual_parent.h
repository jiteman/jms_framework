...
public:
	virtual int virtual_get_integer() const = 0;
...
// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
public:
	virtual ~Virtual_parent() noexcept = 0;
...
// # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
private:
	pointing::Shared< sensing_mipa::sensation_of_mipa_Construction_and_destruction > _the_virtual_parent_sensor;
