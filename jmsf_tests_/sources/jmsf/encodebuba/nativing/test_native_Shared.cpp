...
CULE_TEST( native_Shared, should_be_empty_after_creation ) {
	...
	This_native( empty_native_shared ).should_be_empty();
}
...
CULE_TEST( native_Shared, should_be_equal_empty_empty ) {
	...
	This_native( native_Shared< int >() == native_Shared< int >() ).should_be();
	This_native( empty_native_shared == empty_native_shared ).should_be();
	This_native( empty_native_shared == native_Shared< int >() ).should_be();
	This_native( native_Shared< int >() == empty_native_shared ).should_be();
}
...
CULE_TEST( native_Shared, should_copy_empty ) {
	...
	This_native( empty_native_shared ).should_be_empty();
	This_native( empty_native_shared_1 ).should_be_empty();
	This_native( empty_native_shared_1.is_not_empty() ).should_not_be();
//	This( typeing::Memory_natural_nil ).should_be_equal_to( empty_native_shared_1.get_connectivity().get_total_connectivity() );
}
...
CULE_TEST( native_Shared, should_move_empty ) {
	...
	This_native( empty_native_shared_1 ).should_be_empty();
	This_native( empty_native_shared ).should_be_empty();
	This_native( empty_native_shared == empty_native_shared_1 ).should_be();
}
...
CULE_TEST( native_Shared, should_share_empty_to_paired ) {
	...
	This_native( empty_native_shared ).should_be_empty();
	This_native( empty_native_weak ).should_be_empty();
}
