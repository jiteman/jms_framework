...
CULE_TEST( native_Weak, should_be_equal_empty_empty ) {
	...
	This_native( native_Weak< int >() == native_Weak< int >() ).should_be();
	This_native( empty_native_weak == empty_native_weak ).should_be();
	This_native( empty_native_weak == native_Weak< int >() ).should_be();
	This_native( native_Weak< int >() == empty_native_weak ).should_be();
}
...
CULE_TEST( native_Weak, should_copy_empty ) {
	...
	This_native( empty_native_weak ).should_be_empty();
	This_native( empty_native_weak_1 ).should_be_empty();
	This_native( empty_native_weak_1.is_not_empty() ).should_not_be();
...
CULE_TEST( native_Weak, should_move_empty ) {
	...
	This_native( empty_native_weak_1 ).should_be_empty();
	This_native( empty_native_weak ).should_be_empty();
	This_native( empty_native_weak == empty_native_weak_1 ).should_be();
}
