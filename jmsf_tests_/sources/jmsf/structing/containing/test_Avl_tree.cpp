...
CULE_TEST_F( Avl_tree_empty, should_be_empty_after_creation ) {
	This( *fx_.avl_tree ).should_be_empty();
}

CULE_TEST_F( Avl_tree_empty, should_have_zero_quantity_after_creation ) {
	This( fx_.avl_tree->get_quantity() ).should_be_equal_to( fx_.natural_0 );
}
...
CULE_TEST_F( Avl_tree_empty, should_not_be_empty_after_inserting_any_object ) {
	...
	This( fx_.avl_tree ).should_not_be_empty();
}

CULE_TEST_F( Avl_tree_empty, should_have_nonzero_quantity_after_inserting_any_object ) {
	fx_.avl_tree->insert( fx_.natural_1 );

	This( fx_.avl_tree->get_quantity() ).should_not_be_equal_to( fx_.natural_0 );
}
...
CULE_TEST_F( Avl_tree_empty, should_have_quantity_1_after_1_object_insertion ) {
	...
	This( fx_.avl_tree->get_quantity() ).should_be_equal_to( fx_.natural_1 );
}
...
CULE_TEST_F( Avl_tree_empty, should_have_quantity_equal_to_quantity_of_inserted_unique_objects ) {
	...
	This( fx_.avl_tree->get_quantity() ).should_be_equal_to( fx_.natural_3 );
}
...
CULE_TEST_F( Avl_tree_empty, should_find_inserted_object ) {
	...
	This( fx_.avl_tree->find( fx_.natural_1 ).get_object() ).should_be_equal_to( fx_.natural_1 );
}
...
CULE_TEST_F( Avl_tree_empty, should_find_two_inserted_objects ) {
	...
	This( fx_.avl_tree->find( fx_.natural_1 ) ).should_not_be_empty();
	This( fx_.avl_tree->find( fx_.natural_1 ).get_object() ).should_be_equal_to( fx_.natural_1 );
	This( fx_.avl_tree->find( fx_.natural_2 ) ).should_not_be_empty();
	This( fx_.avl_tree->find( fx_.natural_2 ).get_object() ).should_be_equal_to( fx_.natural_2 );
}
...
CULE_TEST_F( Avl_tree_empty, should_not_find_not_inserted_objects_and_should_return_empty_result ) {
	...
	This( fx_.avl_tree->find( fx_.natural_1 ) ).should_be_empty();
	This( fx_.avl_tree->find( fx_.natural_2 ) ).should_be_empty();
}
...
CULE_TEST_F( Avl_tree_filled, should_find_all_inserted_objects_and_no_others ) {
	...
	This( fx_.avl_tree->find( fx_.natural_0 ) ).should_be_empty();
	This( fx_.avl_tree->find( fx_.natural_1 ) ).should_not_be_empty();
	This( fx_.avl_tree->find( fx_.natural_1 ).get_object() ).should_be_equal_to( fx_.natural_1 );
	This( fx_.avl_tree->find( fx_.natural_2 ) ).should_not_be_empty();
	This( fx_.avl_tree->find( fx_.natural_2 ).get_object() ).should_be_equal_to( fx_.natural_2 );
	This( fx_.avl_tree->find( fx_.natural_3 ) ).should_not_be_empty();
	This( fx_.avl_tree->find( fx_.natural_3 ).get_object() ).should_be_equal_to( fx_.natural_3 );
	This( fx_.avl_tree->find( fx_.natural_4 ) ).should_not_be_empty();
	This( fx_.avl_tree->find( fx_.natural_4 ).get_object() ).should_be_equal_to( fx_.natural_4 );
	This( fx_.avl_tree->find( fx_.natural_5 ) ).should_not_be_empty();
	This( fx_.avl_tree->find( fx_.natural_5 ).get_object() ).should_be_equal_to( fx_.natural_5 );
}
...
CULE_TEST_F( Avl_tree_filled, should_ignore_already_inserted_objects ) {
	...
	This( fx_.avl_tree->find( fx_.natural_3 ).take_node() ).should_be_equal_to( traverser_3.take_node() );
	This( fx_.avl_tree->find( fx_.natural_4 ).take_node() ).should_be_equal_to( traverser_4.take_node() );
}
...
CULE_DISABLED_TEST_F( Avl_tree_filled, should_have_an_appropriate_node_structure ) {
	...
	This( traverser.get_object() ).should_be_equal_to( fx_.natural_5 );
	traverser.move_one_step_up();
	This( traverser.get_object() ).should_be_equal_to( fx_.natural_4 );
	traverser.move_one_step_down_left();
	This( traverser.get_object() ).should_be_equal_to( fx_.natural_1 );
	traverser.move_one_step_down_right();
	This( traverser.get_object() ).should_be_equal_to( fx_.natural_3 );
	traverser.move_one_step_down_left();
	This( traverser.get_object() ).should_be_equal_to( fx_.natural_2 );
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
CULE_DISABLED_TEST_F( Avl_tree_filled, should_recalculate_nodes_heights_after_inserting_new_node ) {
	This( fx_.avl_tree->find( fx_.natural_1 ).take_node()->get_height() ).should_be_equal_to( fx_.natural_3 );
	This( fx_.avl_tree->find( fx_.natural_2 ).take_node()->get_height() ).should_be_equal_to( fx_.natural_1 );
	This( fx_.avl_tree->find( fx_.natural_3 ).take_node()->get_height() ).should_be_equal_to( fx_.natural_2 );
	This( fx_.avl_tree->find( fx_.natural_4 ).take_node()->get_height() ).should_be_equal_to( fx_.natural_4 );
	This( fx_.avl_tree->find( fx_.natural_5 ).take_node()->get_height() ).should_be_equal_to( fx_.natural_1 );
}
...
CULE_TEST_F( Avl_tree_rebalancing, should_perform_rebalancing_using_simple_left_rotation_without_involving_root ) {
	...
	This( fx_.tree_has_correct_childs_after_balancing_without_involving_root() ).should_be();
	This( fx_.tree_has_correct_parents_after_balancing_without_involving_root() ).should_be();
	This( fx_.tree_nodes_has_correct_height_after_balancing_without_involving_root() ).should_be();
}
...
CULE_TEST_F( Avl_tree_rebalancing, should_perform_rebalancing_using_simple_left_rotation_involving_root ) {
	...
	This( fx_.tree_has_correct_childs_after_balancing_involving_root() ).should_be();
	This( fx_.tree_has_correct_parents_after_balancing_involving_root() ).should_be();
	This( fx_.tree_nodes_has_correct_height_after_balancing_involving_root() ).should_be();
}
...
CULE_TEST_F( Avl_tree_imprecise_find, should_find_max_less_and_min_greater_and_no_exact ) {
	...
	This( imprecise_result.get_maximum_less() ).should_not_be_empty();
	This( imprecise_result.get_maximum_less().get_object() ).should_be_equal_to( fx_.natural_30 );
	This( imprecise_result.get_minimum_greater() ).should_not_be_empty();
	This( imprecise_result.get_minimum_greater().get_object() ).should_be_equal_to( fx_.natural_40 );
	This( imprecise_result.get_exact() ).should_be_empty();
}
...
CULE_TEST_F( Avl_tree_imprecise_find, should_find_max_less_and_min_greater_and_no_exact_in_corner_node ) {
	...
	This( imprecise_result.get_maximum_less() ).should_not_be_empty();
	This( imprecise_result.get_maximum_less().get_object() ).should_be_equal_to( new_node_value );
	This( imprecise_result.get_minimum_greater() ).should_not_be_empty();
	This( imprecise_result.get_minimum_greater().get_object() ).should_be_equal_to( fx_.natural_70 );
	This( imprecise_result.get_exact() ).should_be_empty();
}
...
CULE_TEST_F( Avl_tree_imprecise_find, should_find_max_less_only_in_right_corner_node ) {
	...
	This( imprecise_result.get_maximum_less() ).should_not_be_empty();
	This( imprecise_result.get_maximum_less().get_object() ).should_be_equal_to( fx_.natural_70 );
	This( imprecise_result.get_minimum_greater() ).should_be_empty();
	This( imprecise_result.get_exact() ).should_be_empty();
}
...
CULE_TEST_F( Avl_tree_imprecise_find, should_find_min_greater_only_in_left_corner_node ) {
	...
	This( imprecise_result.get_minimum_greater() ).should_not_be_empty();
	This( imprecise_result.get_minimum_greater().get_object() ).should_be_equal_to( fx_.natural_10 );
	This( imprecise_result.get_maximum_less() ).should_be_empty();
	This( imprecise_result.get_exact() ).should_be_empty();
}
...
CULE_TEST_F( Avl_tree_imprecise_find, should_find_max_less_and_min_greater_and_exact ) {
	...
	This( imprecise_result_30.get_maximum_less() ).should_not_be_empty();
	This( imprecise_result_30.get_maximum_less().get_object() ).should_be_equal_to( fx_.natural_20 );
	This( imprecise_result_30.get_minimum_greater() ).should_not_be_empty();
	This( imprecise_result_30.get_minimum_greater().get_object() ).should_be_equal_to( fx_.natural_40 );
	This( imprecise_result_30.get_exact() ).should_not_be_empty();
	This( imprecise_result_30.get_exact().get_object() ).should_be_equal_to( fx_.natural_30 );
}
...
CULE_DISABLED_TEST_F( Avl_tree_imprecise_find, should_find_max_less_and_min_greater_and_exact_in_middle_node ) {
	...
	This( imprecise_result_60.get_maximum_less() ).should_not_be_empty();
	This( imprecise_result_60.get_maximum_less().get_object() ).should_be_equal_to( fx_.natural_50 );
	This( imprecise_result_60.get_minimum_greater() ).should_not_be_empty();
	This( imprecise_result_60.get_minimum_greater().get_object() ).should_be_equal_to( fx_.natural_70 );
	This( imprecise_result_60.get_exact() ).should_not_be_empty();
	This( imprecise_result_60.get_exact().get_object() ).should_be_equal_to( fx_.natural_60 );
}
...
//	fx_.avl_tree->remove( fx_.natural_10 );
	...
	This( fx_.all_nodes_are_inplace_except( fx_.natural_10 ) ).should_be();
}
