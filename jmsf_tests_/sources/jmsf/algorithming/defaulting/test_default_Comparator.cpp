...
CULE_TEST_FIXTURE( default_Comparator_for_naturals ),
...
public:
	void set_up() override {
		comparator =
			algorithming::defaulting::default_Comparator< typeing::Memory_natural >::create(
...
// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
CULE_TEST_FIXTURE( default_Comparator_for_integers ),
	public ::jmsf::testing::typeing::testing_Integer_values< typeing::Memory_integer >
{
public:
	void set_up() override {
		comparator =
			algorithming::defaulting::default_Comparator< typeing::Memory_integer >::create(
				testing::testing_Allocators::instance()->get_testing_object_allocator() );
	}
